...
from clientServer.serverKeys import USER_SERVICES_API_KEY
...
def all_admins():
    ...
    admin_jsons = [
        UserSerializer.serialize_user_with_email(
            admin, current_user, USER_SERVICES_API_KEY
        )
        for admin in admins
    ]
...
def create_admin():
    ...
    return {
        ...
        "admin": UserSerializer.serialize_user_with_email(
            created_admin_user, current_user, USER_SERVICES_API_KEY
        ),
    }, 200
