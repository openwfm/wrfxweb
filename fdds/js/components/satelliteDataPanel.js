...
export class satelliteDataPanel extends HTMLElement {
    constructor() {
        super();
        this.innerHTML = `
            <div id="satellite-data-panel" class="feature-controller hidden" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">
    ...
    connectedCallback() {
        const panel = this.querySelector('#satellite-data-panel');
        const closeBtn = this.querySelector('#close-media');

        // Make panel draggable 
        dragElement(panel, "#satellite-data-panel");
