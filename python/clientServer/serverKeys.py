...
WRFXCTRL_SERVER_URL = os.getenv("WRFXCTRL_SERVER_URL", "")
WRFXCTRL_API_KEY = os.getenv("WRFXCTRL_API_KEY", "")
WRFXCTRL_BUILD_HTML = os.getenv("WRFXCTRL_BUILD_HTML", "")
WRFXCTRL_OVERVIEW_HTML = os.getenv("WRFXCTRL_OVERVIEW_HTML", "")
WRFXCTRL_START_HTML = os.getenv("WRFXCTRL_START_HTML", "")
WRFXCTRL_JS_FOLDER = os.getenv("WRFXCTRL_JS_FOLDER", "")
WRFXCTRL_FOLDER = os.getenv("WRFXCTRL_FOLDER", "")
WRFXCTRL_CONF = os.getenv("WRFXCTRL_CONF", "")
WRFXCTRL_CLUSTER = os.getenv("WRFXCTRL_CLUSTER", "")
WRFXCTRL_PROFILES = os.getenv("WRFXCTRL_PROFILES", "")
